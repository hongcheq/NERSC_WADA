...
## ============
## Please 1. modify scripts/ccsm_utils/Machines/config_compilers.xml to delete -DTOPOTEST
## so that the TOPO condensational heating is not imcluded in this CTR run
## 2 for year 1989, modify ozone prescription in UltraCAM-spcam2_0_cesm1_1_1/models/atm/cam/bld/namelist_files/use_cases/hp_1850-2013_cam5.xml
## ===========
...
setenv CASE        F_AMIP_CAM5_WADA_CTR_1989_production_sim2
...
./xmlchange  -file env_run.xml -id  STOP_N        -val '111'
...
fincl3 = 'CLOUD:A','U:A','V:A','OMEGA:A','PBLH:A','rhten_PBL:A','tten_PBL:A','PRECT:A','PRECC:A','PRECL:A','PS:A','Q:A','RELHUM:A','T:A','TAP:I','PTTEND:A','DTV:I','DTCORE:A','QRL:A','QRS:A','DTCOND:A','TTGWORO:A','TKE:A','TS:A','Z3:A','ZMDT:A','EVAPTZM:A','ZMMTT:A','CMFDT:A','SHFLX:A',"LHFLX:A","SWCF:A","LWCF:A","FLNS:A","FSNS:A","FSDS:A","TREFHT:A"
