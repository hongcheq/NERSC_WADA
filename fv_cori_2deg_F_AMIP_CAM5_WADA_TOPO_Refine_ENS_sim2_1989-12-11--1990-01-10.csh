...
#set year1_vars = (1993 1994 1995 1996 1997 1998 1999 2000 2001 2002 2003 2004 2005 2006 2007 2008)
#set year2_vars = (1994 1995 1996 1997 1998 1999 2000 2001 2002 2003 2004 2005 2006 2007 2008 2009)
# 1989, 1990, 1991, 1992 already done (note: 1989 should be done individually due to ozone prescription)
...
#set run_start_date = "1993-11-21"
set run_start_date = $year1_vars[$numyear]"-11-21"
set start_tod      = "00000"
set Np             = 1024 
set Np_else        = 128

#set date_vars = ($year1_vars[$numyear]"-12-01" $year1_vars[$numyear]"-12-11" $year1_vars[$numyear]"-12-21" $year1_vars[$numyear]"-12-31" $year2_vars[$numyear]"-01-10" $year2_vars[$numyear]"-01-20" $year2_vars[$numyear]"-01-30" $year2_vars[$numyear]"-02-09" $year2_vars[$numyear]"-02-19")
set date_vars = ($year1_vars[$numyear]"-12-11" $year1_vars[$numyear]"-12-21" $year1_vars[$numyear]"-12-31" $year2_vars[$numyear]"-01-10")


@ num = 1
#while ($num < 10)
while ($num < 5)
setenv rdate       $date_vars[$num]

setenv base_build F_AMIP_CAM5_WADA_TOPO_1989_sim2_1989-12-01_HCforcing_Modi_plus_macro_and_micro

#### ============
## Please modify scripts/ccsm_utils/Machines/config_compilers.xml to add -DTOPOTEST
...
#setenv CASE        F_AMIP_CAM5_WADA_TOPO20_1993_test1_1993-12-01
setenv CASE        F_AMIP_CAM5_WADA_TOPO_$year1_vars[$numyear]_sim2_$date_vars[$num]_HCforcing_Modi_plus_macro_and_micro
...
setenv REFCASE     F_AMIP_CAM5_WADA_CTR_$year1_vars[$numyear]_production_sim2
...
./xmlchange -file env_build.xml -id EXEROOT -val $PTMP/$base_build/bld
...
cd $RUNDIR
sed -i 's/'$year2_vars[$numyear]'-03-11/'$rdate'/' rpointer.atm
sed -i 's/'$year2_vars[$numyear]'-03-11/'$rdate'/' rpointer.drv
sed -i 's/'$year2_vars[$numyear]'-03-11/'$rdate'/' rpointer.ice
sed -i 's/'$year2_vars[$numyear]'-03-11/'$rdate'/' rpointer.lnd
sed -i 's/'$year2_vars[$numyear]'-03-11/'$rdate'/' rpointer.ocn
...
@ num++
end  # for while num statement

@ numyear++
end # for while numyear statement
